...
void setup(void)
{
  ...
  if(!bno.begin())
  {
    ...
    Serial.print("tilt error ! Check your wiring or I2C ADDR!");
    while(1);
  }
...
*/
/**************************************************************************/
unsigned long prev=0,prev2=0;
double pres,temp,alt,depth;
void loop(void)
{
...
//format data *dummy,dummy,pitch,roll,yaw,press,temp,depth,altitude,dummy,dummy#
